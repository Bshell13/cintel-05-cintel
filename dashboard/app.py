...
# This is a PyShiny Express app used to show a data stream
# of updating fake temperatures to a DEQUE.
# The temperatures are graphed as a scatter plot with a regression line.
# The range of the temperatures are controled by the user with numeric inputs. 
...
with ui.sidebar(open="open"):
    ...
    ui.h2("Gardner Temperature", class_="text-center")
    ui.p(
        "A demonstration of real-time temperature readings in Gardner, Kansas.",
        class_="text-center",
    )
    ui.hr()
